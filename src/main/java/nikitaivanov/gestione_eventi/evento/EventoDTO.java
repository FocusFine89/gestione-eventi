...
public record EventoDTO(
        ...
        String titolo,
        String descrizione,
        @NotEmpty(message = "Non puoi lasciare la data vuota")
        LocalDate data,
        ...
        String luogo,
        @NotEmpty(message = "Non puoi lasciare il campo dei posti vuoto")
        int posti,
        @NotEmpty(message = "Non puoi lasciare il campo dell'organizzatore vuoto")
